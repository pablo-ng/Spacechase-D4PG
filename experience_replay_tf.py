...
class UniformReplayBuffer(tf.Module):
    ...
    def __init__(self, data_spec):
        super(UniformReplayBuffer, self).__init__(name="UniformReplayBuffer")
...
class PrioritizedReplayBufferProportional(tf.Module):
    ...
    def __init__(self, data_spec):
        ...
        super(PrioritizedReplayBufferProportional, self).__init__(name="PrioritizedReplayBufferProportional")
        self.device = Params.DEVICE
